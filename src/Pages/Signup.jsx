...
export default function Signup() {
  ...
  const handleLoginClick = () => {
    // Navigate to login page (you would typically use React Router here)
    navigate('/')
  };
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all hover:scale-105">
        <div className="bg-gradient-to-r from-indigo-600 to-violet-600 py-6 px-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <h2 className="text-3xl font-extrabold text-white tracking-tight">Join Us Today</h2>
            <p className="mt-2 text-sm text-indigo-200">Create your account and start your journey</p>
          </div>
        </div>
